...
- Batch manifests now report evidence-backed rerun scope and executable failed/pending rerun. Playlist support and deeper policy-affected or Canonical IR id-level batch targeting remain tied to later playlist and M5/C3 work.
